...
class ReliqTheme {
  ...
  static TextTheme _textTheme(Color t1, Color t2, Color t3) {
    return TextTheme(
      // Headings
      displayLarge:  GoogleFonts.plusJakartaSans(fontSize: 32, fontWeight: FontWeight.w700, color: t1, letterSpacing: -0.5),
      displayMedium: GoogleFonts.plusJakartaSans(fontSize: 26, fontWeight: FontWeight.w700, color: t1, letterSpacing: -0.3),
      displaySmall:  GoogleFonts.plusJakartaSans(fontSize: 22, fontWeight: FontWeight.w600, color: t1),
      headlineMedium:GoogleFonts.plusJakartaSans(fontSize: 18, fontWeight: FontWeight.w600, color: t1),
      headlineSmall: GoogleFonts.plusJakartaSans(fontSize: 16, fontWeight: FontWeight.w600, color: t1),
      titleLarge:    GoogleFonts.plusJakartaSans(fontSize: 15, fontWeight: FontWeight.w600, color: t1),
      titleMedium:   GoogleFonts.plusJakartaSans(fontSize: 14, fontWeight: FontWeight.w500, color: t1),
      titleSmall:    GoogleFonts.plusJakartaSans(fontSize: 13, fontWeight: FontWeight.w500, color: t2),
      // Body
      bodyLarge:     GoogleFonts.plusJakartaSans(fontSize: 15, fontWeight: FontWeight.w400, color: t1, height: 1.6),
      bodyMedium:    GoogleFonts.plusJakartaSans(fontSize: 14, fontWeight: FontWeight.w400, color: t1, height: 1.5),
      bodySmall:     GoogleFonts.plusJakartaSans(fontSize: 12, fontWeight: FontWeight.w400, color: t2, height: 1.4),
      // Labels
      labelLarge:    GoogleFonts.plusJakartaSans(fontSize: 14, fontWeight: FontWeight.w600, color: t1),
      labelMedium:   GoogleFonts.plusJakartaSans(fontSize: 12, fontWeight: FontWeight.w500, color: t2),
      labelSmall:    GoogleFonts.plusJakartaSans(fontSize: 11, fontWeight: FontWeight.w400, color: t3),
    );
  }
  ...
  static ThemeData light = ThemeData(
    ...
    chipTheme: ChipThemeData(
      ...
      secondaryLabelStyle: GoogleFonts.plusJakartaSans(fontSize: 13, color: _lightSurface),
      side: const BorderSide(color: _lightBorder),
  ...
  static ThemeData dark = ThemeData(
    ...
    chipTheme: ChipThemeData(
      ...
      secondaryLabelStyle: GoogleFonts.plusJakartaSans(fontSize: 13, color: _darkBg),
      side: const BorderSide(color: _darkBorder),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
    ),
